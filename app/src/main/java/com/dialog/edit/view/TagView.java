...
public class TagView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.bg_tag_log;
    ...
    private static final int DEFAULT_TAG_RESID = R.layout.tag_item;
    private static final int DEFAULT_RIGHT_IMAGE = R.mipmap.ic_arrow_right;
    ...
    public TagView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTagBorderHor = a.getDimensionPixelSize(
                R.styleable.TagView_tcvItemBorderHorizontal, DEFAULT_TEXT_BORDER_HORIZONTAL);
        mTagBorderVer = a.getDimensionPixelSize(
                R.styleable.TagView_tcvItemBorderVertical, DEFAULT_TEXT_BORDER_VERTICAL);
